...
namespace WorkflowProcessingModel.Model
{
    class Storehouse
    {
        ...
        public double TimeNeededToTransportProductsToProductionHall { get; set; }

        public Storehouse(int index, string name, Dictionary<Material, int> availableMaterials, double timeNeededToTransportProductsToProductionHall)
        {
            Index = index;
